...
var slideNum = 0;
    ...
    $(window).on("load", function () {
        /*$('.slider').fractionSlider({
            ...
            'nextSlideCallback': function() {
                ...
                var ele = $('.slider-wrapper');
                ele.css('background-image', 'url(../montrealundergroundcity/assets/images/banner' + slideNum + '.jpg)');
                //alert(ele.css('background-image'));
            },
            ...
            //     console.log('startNextSlideCallback');
            // },
   ...
   $("#beautyhealth-slide").owlCarousel({
        //  autoPlay: 5000,
        items: 4,
        itemsDesktop: [1199, 3],
        itemsDesktopSmall: [980, 3],
