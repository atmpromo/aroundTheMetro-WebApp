...
<div id="page-content">
    <section class="header" style="background-image:url(<?php echo base_url(); ?>assets/images/stores.jpg);">
        <div class="container">
            <div class="row">
...
<?php
 foreach ($stores as $store){ ?>	
  ...
  <?php } ?>
          ...
          <a href="<?php echo getURLPrefix($language, 'store_details').'/'.$store['id']; ?>"><img class="stores_img" src="<?php echo $this->config->item('download_prefix_store').$store['imagename']; ?>" alt="<?php echo $store['name']; ?>"></a>
          <div class="caption">
            <h3><?php echo $store['name']; ?></h3>
            <p><?php echo $store['mallname']; ?></p>
            <p><?php echo $store['metroname']; ?></p>
          </div>
        </div>
      </div>
