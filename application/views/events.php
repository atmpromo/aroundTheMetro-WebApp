...
<div id="page-content">
    <section class="header" style="background-image:url(<?php echo base_url(); ?>assets/images/events.jpg);">
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="blog-content">
                                <div class="blog-img image-hover">
                                    <a href="<?php echo $event['link']; ?>"><img src="<?php echo $this->config->item('download_prefix_event').$event['imagename']; ?>" class="img-responsive" alt=""></a>
