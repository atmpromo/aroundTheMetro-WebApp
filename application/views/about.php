<div id="page-content">
	<section class="header"  style="background-image:url(<?php echo base_url(); ?>assets/images/about.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="header-content">
                        <div class="header-content-inner">
                            <h1><?php echo getLocalizedString($language, "Aboutus"); ?></h1>
                ...
                <div class="row">
                    <div class="col-md-offset-2 col-md-8">
                        <div class="section-title text-center">
                            ...
                            <h2><?php echo getLocalizedString($language, "Aboutus"); ?></h2>
